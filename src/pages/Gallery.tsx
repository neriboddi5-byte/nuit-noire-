export default function Gallery() {
  return (
    <div className="pt-32 pb-24 px-6 md:px-12 max-w-7xl mx-auto min-h-screen text-center relative">
      ...
      <span className="micro-label mb-4 block">Visual Evidence</span>
      <h1 className="text-display text-6xl mb-8">ARCHIVES</h1>
      <p className="text-white/60 mb-16 text-subheading">What happens in the dark.</p>

      <div className="glass-panel p-16 max-w-2xl mx-auto">
         <p className="text-white/60 text-lg">No media has been released. The syndicate limits traces.</p>
      </div>
    </div>
  );
}
